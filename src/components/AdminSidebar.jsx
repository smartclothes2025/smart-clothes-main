    ...
    <aside className="left-sidebar bg-gray-100" >
      <div className="mt-6 flex-1 overflow-y-auto px-2">
        <nav className="space-y-2">
          ...
          <Link to="/admin/Clothes" className="flex items-center gap-3 px-3 py-2 rounded hover:bg-gray-100">
            <Icon icon="mdi:hanger" className="w-5 h-5" />
            <span>衣櫃管理</span>
          </Link>

          <Link to="/admin/Posts" className="flex items-center gap-3 px-3 py-2 rounded hover:bg-gray-100">
            <Icon icon="mdi:post-outline" className="w-5 h-5" />
            <span>貼文管理</span>
          </Link>
